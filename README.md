...
3. [Dev MVP : 서버1팀] 개발자 김현웅님을 만나다. 
4. [Dev MVP : 서버1팀 김현웅님] "메쉬코리아 개발자는 모두 개발을 즐기고 아는 것을 공유하고자 하는 분들"
5. [서버1팀 인터뷰] 동료들과 함께 성장해나가는 개발자, 김현웅님
6. [서버1팀 인터뷰] 개발자 김현웅님
7. [개발자 인터뷰] 동료들과 함께 성장해나가는 개발자, 서버1팀 박진우님
8. [인터뷰] 서버1팀 개발자 김현웅님
